...
Project of [Getting and Cleaning Data course on Coursera](https://www.coursera.org/course/getdata), Oct 2014 edition.
...
As a result than you find the tidy data set .`UCI_tidy_data_set.txt` with the tidy data set.
